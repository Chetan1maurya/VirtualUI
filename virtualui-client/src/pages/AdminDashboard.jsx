    ...
    <div className="px-4 sm:px-6 lg:px-8 py-5 sm:py-6 max-w-3xl w-full mx-auto">
      ...
      <div className="space-y-4 sm:space-y-5">
        ...
        <div className="rounded-2xl border border-white/7 bg-white/2 overflow-hidden">
          <div className="flex items-center justify-between px-3.5 sm:px-4 py-3 border-b border-white/6">
...
const AdminDashboard = () => {
  ...
  const publicComponents = allComponents?.filter(
    ...
    <>
      ...
      <div className="p-3 border-t border-white/5">
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-red-400/70 hover:text-red-400 hover:bg-red-500/6 transition-all cursor-pointer bg-transparent border-none text-left"
        >
        ...
        <div className="sticky top-0 z-10 px-4 sm:px-6 lg:px-8 py-3.5 sm:py-4 bg-[#030b0d]/90 backdrop-blur-md border-b border-white/5 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-3 min-w-0">
            <button
              ...
              className="md:hidden bg-transparent border-none cursor-pointer p-1.5 rounded-lg text-white/50 hover:text-white/80 hover:bg-white/5 transition-all shrink-0"
            >
              <TbMenu2 size={20} />
            </button>
          ...
          <motion.button
            ...
            className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold text-[#030b0d] bg-linear-to-br from-[#3be8ff] to-[#0ab5d4] hover:opacity-90 transition-all shadow-[0_0_20px_rgba(59,232,255,0.2)] cursor-pointer border-none shrink-0"
          >
            <TbPlus />
          ...
          {activeView === "dashboard" && (
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {stats.map(({ label, value, icon: Icon, color }, i) => (
                  <motion.div
                    ...
                    className="p-3.5 sm:p-4 rounded-2xl border border-white/7 bg-white/2 hover:border-white/12 transition-all"
                  >
              ...
              <motion.div
                ...
                className="p-4 sm:p-5 rounded-2xl border border-white/7 bg-white/2"
              >
                <div className="flex items-start sm:items-center justify-between mb-4 sm:mb-5 gap-2">
                  ...
                  <span className="text-[10px] font-semibold px-2 sm:px-2.5 py-1 rounded-full bg-[#a78bfa]/10 text-[#a78bfa] border border-[#a78bfa]/20 shrink-0">
                    Last 12 days
                  </span>
                </div>
                {chartData?.length === 0 ? (
              ...
              {/* Public Components */}
              <motion.div className="rounded-2xl border border-white/7 bg-white/2 overflow-hidden">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-4 sm:px-5 py-4 border-b border-white/5">
                  ...
                  <div className="relative w-full sm:w-48">
                    ...
                    <input
                      ...
                      className="w-full bg-white/4 bordere border-white/10 rounded-xl pl-8 pr-3 py-2 text-xs text-white placeholder-white/25 outline-none focus:border-[#3be8ff]/40 transition-colors"
                    />
                  </div>
                </div>
