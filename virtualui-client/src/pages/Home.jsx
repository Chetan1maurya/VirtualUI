...
const steps = [
  {
    ...
    text: "npm install virtual-library-ui to access all prebuilt UI components.",
  },
  {
    n: "02",
    title: "Use Components",
    text: "Import and customize with props for any design requirements.",
  },
  {
    n: "03",
...
const Home = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("npm install virtual-library-ui");
    setCopied(true);
  ...
  return (
    ...
    bg-[radial-gradient(circle_at_center,rgba(59,232,255,0.05)_1px,transparent_1px)]
    bg-size-[26px_26px]
    opacity-70
  "
      />
      ...
      <nav className="sticky top-0 z-40 flex items-center justify-between px-4 sm:px-8 lg:px-10 py-4 border-b border-white/5 bg-[#030b0d]/85 backdrop-blur-md">
        ...
        <div className="hidden md:flex items-center gap-6 lg:gap-8 text-sm text-white/50">
          <button onClick={() => navigate("/components")} className="duration-200 px-6 py-2.5 border border-white/15 rounded-xl text-sm text-white/70 hover:text-white hover:border-white transition-all cursor-pointer bg-transparent w-full">
            Components
          </button>
          {userData ? (
              ...
              <AnimatePresence>
                {profileOpen && (
                  <motion.div
                    ...
                    exist={{ opacity: 0, y: 6, scale: 0.96 }}
                  ...
                  >
                    ...
                    <div className="border-t border-white/7 py-1.5">
                      <button
        ...
        {menuOpen && (
          ...
          >
            ...
            {userData ? (
              ...
              <button
                className="flex items-center justify-center gap-2 bg-[#3be8ff] text-[#030b0d] px-4 py-2.5 rounded-lg text-sm font-semibold cursor-pointer border-none mt-1 text-nowrap"
                onClick={() => {
                  setShowAuth(true);
                  setMenuOpen(false);
                  handleGenerateClick
      ...
      <section className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-16 sm:pt-24 pb-12 sm:pb-20 text-center">
        ...
        >
          Build React UI <br />
          <span className="text-transparent bg-clip-text bg-linear-to-br from-[#3be8ff] to-[#0ab5d4]">
            {" "}
            Faster with AI
          </span>
        </motion.h1>
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3 bg-white/4 border border-white/10 rounded-xl px-4 sm:px-5 py-3 text-xs sm:text-sm font-mono w-full max-w-xs sm:max-w-fit">
            ...
            <span className="text-white/80 truncate">
              npm install virtual-library-ui
            </span>
            <button
              onClick={handleCopy}
        ...
        <motion.div
          ...
          className="mt-12 sm:mt-16 mx-auto max-w-2xl bg-[#0a1a1e]/80 border border-white/7 rounded-2xl p-4 sm:p-5 text-left shadow-[0_30px_60px_rgba(0,0,0,0.4)] backdrop-blur-sm overflow-x-auto"
        >
          ...
          <div className="font-mono text-[11px] sm:text-[12.5px] leading-6 space-y-0.5 min-w-70">
            <p>
              ...
              <span className="text-[#aaff80]">virtual-library-ui</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {features.map((item, index) => (
            <motion.div
              ...
              key={index}
              className="group p-5 sm:p-6 rounded-2xl border border-white/7 bg-white/2 hover:bg-[#3be8ff]/20 transition-all duration-300"
            >
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        ...
        <div className="relative grid grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="hidden lg:block absolute top-8 left-[12.5%] right-[12.5%] h-px bg-linear-to-br from-transparent via-[#3be8ff]/20 to-transparent" />
           <motion.div
    className="hidden lg:block absolute top-8 left-[12.5%] h-px bg-[#3be8ff] shadow-[0_0_12px_#3be8ff]"
    initial={{ width: 0 }}
     animate={{
    x: ["0%", "100%"],
  }}
  ...
  />
          {steps.map((step, index) => (
            ...
            >
              <div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-4 sm:mb-5 rounded-2xl bg-linear-to-br from-[#0e2528] to-[#071518] border border-[#3be8ff]/20 flex flex-col items-center justify-center group-hover:border-[#3be8ff]/40 group-hover:shadow-[0_0_20px_rgba(59,232,255,0.1)] transition-all duration-300">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h3
              ...
              style={{ fontFamily: "'Syne', sans-serif" }}
            >
              Ready to generate your new component?
            </h3>
            {userData ? (
              <>
      ...
      <footer className="border-t border-white/5 py-8 sm:py-10">
        ...
        <p className="text-xs text-white/25 order-last sm:order-0">© {new Date().getFullYear()} VirtualUI. All rights reserved.</p>
        </div>
      </footer>
